                ...
                connection.query(
                    ...
                    if (user_quantity > res[0].stock_quantity) {
                        ...
                        connection.query("SELECT * FROM products", function(err) {
                            ...
                            totalPurchased = parseInt(user_quantity) + res[0].num_product_sales;
                                connection.query("UPDATE products SET ? WHERE ?", 
                                [
                                    {
                                        num_product_sales: totalPurchased
                                    },
                                    {
                                        id: x
                                    }
            ...
            .prompt([
                ...
                if (again) {
                    ...
                    connection.query("SELECT * FROM financial", function(err,assets) {
                        ...
                        if (err) throw err;
                        profits = assets[0].current_assets + userCartTotal

                        connection.query("UPDATE financial SET current_assets = ?", [profits], function(err) {
                            if (err) throw err;
